            ...
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <div class="action-nav-normal">
                        ...
                        <input type="text" name="s_name" placeholder="username" required="required"/>
                        <input type="password" name="f_name" placeholder="password" required="required"/>
                        <input type="submit" name="submit" value="Add User" class="btn-info"/>
                        {{Form::close()}}
