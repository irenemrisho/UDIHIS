	...
	?>
     ...
     <table cellspacing="0" style="padding: 1px; width: 98%; border: solid 2px #000000; font-size: 11pt; ">
                    ...
                    <tr>
						...
						<th style="width: 15%; border: solid 1px #000000;">Parent phone number</th>
...
?>
                    <tr> 
                        ...
                        <td style="width: 15%; border: solid 1px #000000;text-align: left;"><?php echo (($student['PPN']!=null)?"0".substr($student['PPN'],-9):"");?></td>
