...
<td style="text-align:center;">{{"admission_date"}}</td>
<td style="text-align:center;">
<a  href="{{url("manage/$patient->id")}}" 
rel="tooltip" class="btn btn-small fetchuser" data-original-title="manage"  data-toggle="modal">
<i class="icon-edit" ></i>								
</a>
<a href="{{url("allocate_ward/$patient->id")}}" 
	rel="tooltip" data-placement="top" data-original-title="allocate" class="btn btn-small btn-primary">
		<i class="icon-print"></i>
</a>
<a href="{{url("dosage/$patient->id")}}" 
	rel="tooltip" data-placement="top" data-original-title="dosage" class="btn btn-small btn-success">
